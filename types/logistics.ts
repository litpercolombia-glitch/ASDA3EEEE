...
export type MainTabNew = 'seguimiento' | 'info-logistica' | 'modo-admin' | 'conexiones' | 'demanda' | 'gamificacion' | 'semaforo' | 'predicciones' | 'asistente' | 'ml' | 'procesos-litper' | 'ciudad-agentes';
