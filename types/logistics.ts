...
export type MainTabNew = 'seguimiento' | 'flash' | 'demanda' | 'gamificacion' | 'semaforo' | 'predicciones' | 'reporte' | 'asistente' | 'ml' | 'procesos-litper' | 'ciudad-agentes' | 'aprendizaje-ia';
