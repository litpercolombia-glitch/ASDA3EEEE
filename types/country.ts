  ...
  COLOMBIA: {
    ...
    carriers: [
      ...
      },
      {
        ...
        services: [
          { id: 'coord_mercancia', name: 'Mercancía', type: 'standard', avgDays: 3, price: 'medium' },
      ...
      },
      {
        ...
        services: [
          ...
          { id: 'deprisa_standard', name: 'Estándar', type: 'standard', avgDays: 2, price: 'medium' },
        ],
      },
    ],
  },
    ...
    carriers: [
      {
        ...
        services: [
          ...
          { id: 'servi_ec_standard', name: 'Estándar', type: 'standard', avgDays: 2, price: 'medium' },
        ],
      },
      {
        id: 'tramaco',
        ...
        services: [
          ...
          { id: 'tramaco_standard', name: 'Estándar', type: 'standard', avgDays: 3, price: 'medium' },
      ...
      },
      {
        ...
        services: [
          { id: 'correos_express', name: 'EMS Express', type: 'express', avgDays: 2, price: 'high' },
          { id: 'correos_standard', name: 'Certificado', type: 'standard', avgDays: 5, price: 'low' },
        ],
      },
    ],
  },
    ...
    carriers: [
      {
        ...
        services: [
          { id: 'chilex_priority', name: 'Prioritario', type: 'express', avgDays: 1, price: 'high' },
          { id: 'chilex_dia_sig', name: 'Día Siguiente', type: 'standard', avgDays: 2, price: 'medium' },
      ...
      },
      {
        ...
        services: [
          ...
          { id: 'correos_cl_standard', name: 'Certificado', type: 'standard', avgDays: 4, price: 'medium' },
        ],
      },
      {
        id: 'fedex_chile',
        ...
        services: [
          { id: 'fedex_priority', name: 'Priority Overnight', type: 'express', avgDays: 1, price: 'high' },
