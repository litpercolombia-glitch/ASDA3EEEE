...
export const LoginPage: React.FC<LoginPageProps> = ({ onSwitchToRegister }) => {
  const { login, initiateGoogleLogin, isLoading, error, clearError } = useAuthStore();
  ...
  // Google OAuth real — delega a Supabase que maneja la redirección a Google
            ...
            <div className="p-8 lg:p-10">
              ...
              <div className="mb-6">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 p-3.5 rounded-xl border border-white/10
                    bg-white/[0.02] hover:bg-white/[0.08] hover:border-white/25
                    transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg className="w-5 h-5 flex-shrink-0 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" aria-hidden="true">
