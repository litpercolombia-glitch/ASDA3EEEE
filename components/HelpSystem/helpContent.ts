...
export const knowledgeLibraryHelp = {
  ...
  biblioteca: {
    ...
    content:
      'Carga y gestiona información desde múltiples fuentes. Los agentes IA usarán este conocimiento para darte mejores respuestas.',
    tips: [
  ...
  cargarArchivo: {
    ...
    content:
      'Sube documentos PDF, DOCX, TXT y más. El sistema extraerá el texto y lo clasificará automáticamente.',
    steps: [
  ...
  cargarWeb: {
    ...
    content:
      'Extrae contenido de cualquier página web. Ideal para documentación, blogs y artículos.',
    steps: [
  ...
  cargarYouTube: {
    ...
    content:
      'Extrae la transcripción completa de videos de YouTube. Incluye timestamps cada minuto.',
    steps: [
  ...
  busqueda: {
    ...
    content:
      'Busca por significado, no solo palabras exactas. Escribe frases completas para mejores resultados.',
    steps: [
...
export const mlSystemHelp = {
  ...
  dashboard: {
    title: 'Dashboard ML',
    content:
      'Visualiza el estado de los modelos de machine learning y sus métricas de rendimiento.',
    tips: [
  ...
  predicciones: {
    ...
    content:
      'El sistema predice la probabilidad de retraso para cada envío basándose en datos históricos.',
    steps: [
...
export const seguimientoHelp = {
  ...
  general: {
    ...
    content:
      'Monitorea todos tus envíos en tiempo real. Filtra por estado, transportadora o ciudad.',
    tips: [
...
export const chatHelp = {
  general: {
    ...
    content:
      'Pregunta cualquier cosa sobre tus envíos en lenguaje natural. El asistente IA analizará tus datos y responderá.',
    steps: [
...
export const agentesHelp = {
  general: {
    ...
    content:
      'Sistema de agentes inteligentes que trabajan coordinadamente para optimizar tus operaciones.',
    tips: [
 ...
 */
export const getHelpForSection = (section: string, key: string): HelpContentItem | undefined => {
